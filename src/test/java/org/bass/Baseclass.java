...
public class Baseclass {
	...
	// 55. EnterNewSheet
	public void enterNewSheet(String Sheetvalue, int rownum, int cellnum, String data) throws IOException {
		File file = new File("C:\\Users\\Administrator\\eclipse-workspace\\FrameWork\\Excel\\HotelDetail.xlsx");
	...
	// 59. Getdata
	public String getData(String sheetName, int rownum, int cellnum) throws InvalidFormatException, IOException {
		String data = null;
		File file = new File("C:\\Users\\Administrator\\eclipse-workspace\\FrameWork\\Excel\\HotelDetail.xlsx");
	...
	// 60.update/modify
	public void updateValue(String sheetName, int rownum, int cellnum, String olddata, String newdata)
	...
	public void writedataRowcell(String sheetName, int rowno, int cellno, String data)
	...
	public static void waittime(long value) {
	...
	// 65.Take ScreenShot for WebElement
	...
	// 66. To take screenshot of the page
